                ...
                <div className="row">
                    <div className="col-md-2">
                        <div class="list-group">
                            ...
                            {this.props.login.loggedIn &&
                                this.props.login.role == "admin" && (
                                    <Link to="/bookissued" class="list-group-item list-group-item-action list-group-item-success">
                                        Book Issued
                                    </Link>
                                )}
                            {this.props.login.loggedIn &&
                                this.props.login.role == "admin" && (
                                    <Link to="/booksorder" class="list-group-item list-group-item-action list-group-item-secondary ">
                                        Book Order
                                    </Link>
                                )}
                        ...
                        <table className="table  mx-auto mt-5 container-fluid table table-info table-striped ">
                            <thead>
                                <tr>
                                    ...
                                    {this.props.login.loggedIn &&
                                        this.props.login.role == "user" && <th colSpan="2">Action </th>}
                                    {this.props.login.loggedIn &&
                                        this.props.login.role == "admin" && (
